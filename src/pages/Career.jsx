...
const jobs = [
  ...
  },
  {
    ...
    type: 'Full-Time',
    location: 'Salem, Tamil Nadu',
    qualification: "Bachelor's Degree (Any Discipline). Freshers with excellent communication skills are welcome to apply. Experience in Education, Research will be preferred.",
    overview: 'We are looking for a proactive and detail-oriented Conference Coordinator to support our research, conference, training, and business development activities. The role involves participant coordination, conference management, website updates, social media marketing, lead generation, reporting, and maintaining accurate records to ensure successful execution of our programs and services.',
    responsibilities: [
      'Respond to inquiries from students, researchers, faculty members, and institutions.',
      'Guide participants through conference registration, research paper submission, co-author collaboration, and publication support.',
      'Coordinate with authors, reviewers, keynote speakers, and organizing teams.',
      'Follow up with prospective participants to improve registrations and engagement.',
    ],
    skills: [
      'Excellent written and verbal communication skills.',
      'Good knowledge of MS Excel, Word, CMT and Scholar Submit.',
      'Strong organizational and multitasking abilities.',
      'Basic knowledge of social media platforms and digital marketing.',
      'Attention to detail and problem-solving skills.',
      'Ability to work independently and as part of a team.',
      'Experience in conference management, research coordination, training administration, or customer support is an added advantage.',
    ],
    why: [
      'Work on impactful research and conference programs.',
      'Collaborative and growth-oriented work environment.',
      'Continuous learning and professional development opportunities.',
      'Performance-based recognition and career advancement.',
      'Opportunity to network with global researchers and academicians.',
    ],
    applyNote: 'Interested candidates can share your resume through email us',
    closing: 'Join Shazu Soft Technologies and be part of a team driving global research and innovation!',
  },
  {
    title: 'Data Analyst',
    type: 'Full-Time',
